...
(test (arrangements empty) (list empty))

(test (arrangements (list 'a)) (list (list 'a)))

(test (arrangements (list 'a 'b)) (list (list 'a 'b) (list 'b 'a)))

(test (arrangements (list 'a 'b 'c)) (list (list 'a 'b 'c)
                                           (list 'b 'a 'c)
                                           (list 'b 'c 'a)
                                           (list 'a 'c 'b)
                                           (list 'c 'a 'b)
