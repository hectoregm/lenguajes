...
24
\end{verbatim}
\item $\textbf{average}$ - Dado una lista no vacia de numeros, regresar el
...
numroes primos contenidos entre 2 y el numero entero dado, \textit{i.e.}
\begin{verbatim}
> (primes 30)
...
> (mflatten ’((1 4) 2 3))
’(1 4 2 3)
> (mflatten ’((1 (4 5 6)) 2 3))
’(1 4 5 6 2 3)
> (mflatten ’((1 (4 5 6)) 2 (3 (7 9) 8)))
’(1 4 5 6 2 3 7 9 8)
\end{verbatim}
